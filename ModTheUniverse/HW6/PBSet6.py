...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar 12 19:00:16 2018
...
"""Problem 1"""
velocity_i = math.sqrt((G*mass_solar)/AU) #centripetal velocity
time_orbit = (2*math.pi*AU)/velocity_i # time for one prbit
five_orbits=5*time_orbit #time for 5 orbits
dt=time_orbit/200 #time for one orbit in 200 chunks
total_steps = int(five_orbits/dt) #how many steps to get to 5th orbit
